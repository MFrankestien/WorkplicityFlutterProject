...
class PartTimeJobs extends StatefulWidget {
  @override
  _PartTimeJobsState createState() => _PartTimeJobsState();
}

class _PartTimeJobsState extends State<PartTimeJobs> {
  List jobs;
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: JobSeekerHeader(context, titleText: 'Part Time Jobs'),
      body: Container(
        child: Column(
          children: <Widget>[
            Container(
