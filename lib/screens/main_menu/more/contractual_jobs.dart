...
class ContractualJobs extends StatefulWidget {
  @override
  _ContractualJobsState createState() => _ContractualJobsState();
}

class _ContractualJobsState extends State<ContractualJobs> {
  List jobs;
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: JobSeekerHeader(context, titleText: 'Contractual Jobs'),
      body: Container(
        child: Column(
          children: <Widget>[
            Container(
