...
class FollowedJobs extends StatefulWidget {
  @override
  _FollowedJobsState createState() => _FollowedJobsState();
}
class _FollowedJobsState extends State<FollowedJobs> {
  List jobs;
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: JobSeekerHeader(context, titleText: 'Followed Jobs'),
      body: Container(
        child: Column(
          children: <Widget>[
            Container(
