...
class DeadlineTomorrow extends StatefulWidget {
  @override
  _DeadlineTomorrowState createState() => _DeadlineTomorrowState();
}

class _DeadlineTomorrowState extends State<DeadlineTomorrow> {
  List jobs;
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: JobSeekerHeader(context, titleText: 'Deadline Tomorrow'),
      body: Container(
        child: Column(
          children: <Widget>[
            Container(
