...
class AlljobsFirm extends StatefulWidget {
  @override
  _AlljobsFirmState createState() => _AlljobsFirmState();
}

class _AlljobsFirmState extends State<AlljobsFirm> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: Firmheader(context, titleText: 'Hot Jobs'),
